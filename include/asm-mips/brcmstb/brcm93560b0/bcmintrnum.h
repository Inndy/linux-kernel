...
#define BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT 32

/* JPF Serial Code depends on a unique IRQ for each serial port */
#define BCM_LINUX_UARTA_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_reserved0_SHIFT)
#define BCM_LINUX_UARTB_IRQ		(BCM_LINUX_UARTA_IRQ+1)

// 3560A0
//#define BCM_LINUX_USB_HOST_IRQ 	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_0_CPU_INTR_SHIFT)
#define BCM_LINUX_USB_HOST_IRQ 	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_USB20_BRIDGE_INTR_SHIFT)
#define BCM_LINUX_USB_EHCI_CPU_INTR (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_USB20_EHCI_INTR_SHIFT)
#define BCM_LINUX_USB_OHCI_0_CPU_INTR (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_USB20_OHCI_INTR_SHIFT)


#define BCM_LINUX_1394_IRQ 	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_1_CPU_INTR_SHIFT)
#define BCM_LINUX_7411_IRQ 	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_2_CPU_INTR_SHIFT)

/* JPF Each line in the INTC has an IRQ */


#define POD_IRQ_NUM  (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_EXT_IRQ_0_CPU_INTR_SHIFT )


#define BCM_LINUX_EXT_PCI_IRQ	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_3_CPU_INTR_SHIFT)

#define BCM_LINUX_EXPANSION_SLOT (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_3_CPU_INTR_SHIFT)
