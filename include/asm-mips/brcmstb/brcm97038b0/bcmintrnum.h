...
#define POD_IRQ_NUM  (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_EXT_IRQ_1_CPU_INTR_SHIFT )

#define BCM_LINUX_SATA_IRQ	  (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_SATA_CPU_INTR_SHIFT)     /* last one for intc level. */

#define BCM_LINUX_3250_IRQ		(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_1_CPU_INTR_SHIFT)
#define BCM_LINUX_EXT_PCI_IRQ	(1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_0_CPU_INTR_SHIFT)

#define BCM_LINUX_EXPANSION_SLOT (1+BCHP_HIF_CPU_INTR1_INTR_W0_STATUS_reserved0_SHIFT+BCHP_HIF_CPU_INTR1_INTR_W1_STATUS_PCI_INTA_0_CPU_INTR_SHIFT)
