...
/* THT: On the 7110 the IRQ mapping are different.
 * The following list is according to the 7110 Specs dated 5/17/02.
 */

#define	BCM_LINUX_TIMR_IRQ			32
#define	BCM_LINUX_US_IRQ			31
#define	BCM_LINUX_VDEC1_IRQ			30
#define	BCM_LINUX_VDEC0_IRQ			29
#define	BCM_LINUX_UART_IRQ			28
#define	BCM_LINUX_BGE_VEC1_IRQ		27
#define BCM_LINUX_EMAC_IRQ			26
#define BCM_LINUX_BTSC_IRQ			25
#define	BCM_LINUX_ADP_IRQ			24
#define	BCM_LINUX_ATP_IRQ			23
...
#define	BCM_LINUX_OB2_IRQ			16
#define	BCM_LINUX_OB1_IRQ			15
#define	BCM_LINUX_DS2_IRQ			14
#define	BCM_LINUX_DS1_IRQ			13
...
#define	BCM_LINUX_USB_DEV_IRQ		7
#define	BCM_LINUX_DAVIC_MAC_IRQ		6
#define	BCM_LINUX_DOSCIS_MAC_IRQ	5
#define	BCM_LINUX_IDE0_IRQ			4
#define	BCM_LINUX_EBI_TX_IRQ		3
#define	BCM_LINUX_EBI_RX_IRQ		2
#define	BCM_LINUX_DMA_IRQ			1

#define BCM_LINUX_IDE_IRQ BCM_LINUX_IDE0_IRQ

#define BCM_LINUX_USB_HOST1_IRQ		BCM_LINUX_USB_HOST_IRQ
/* Soft Modem */
...
/* POD card interrupt. */
#define POD_IRQ_NUM  48
#define POD_DET_IRQ_NUM  49
