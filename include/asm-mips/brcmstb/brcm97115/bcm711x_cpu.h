...
#************************************************************************
*/
#define BCM_CP0_INDEX           $0
#define BCM_CP0_RANDOM			$1
#define BCM_CP0_ENTRYLO0 		$2
#define BCM_CP0_ENTRYLO1 		$3
#define BCM_CP0_CONTEXT 		$4
#define BCM_CP0_PAGEMASK 		$5
#define BCM_CP0_WIRED 			$6
#define BCM_CP0_BVADDR          $8
#define BCM_CP0_COUNT           $9
#define BCM_CP0_ENTRYHI 		$10
#define BCM_CP0_COMPARE         $11
#define BCM_CP0_STATUS          $12
#define BCM_CP0_CAUSE           $13
#define BCM_CP0_EPC             $14
#define BCM_CP0_PRID            $15
#define BCM_CP0_PROCCFG         $16
#define BCM_CP0_LLADDR			$17
#define BCM_CP0_CONFIG          $22
#define BCM_CP0_DEBUG           $23
#define BCM_CP0_DBEXCPC         $24
#define BCM_CP0_TAGLO 			$28
#define BCM_CP0_DESAVE          $31

#define BCM_CP0_BRCM_CONFIG             $22
...
/*define CP0_CFG_WBEN          (0x1 << 29)*/


/* physical address to K seg mapping macros. We have so many of these already defined.
	Hopefully we can all start to use this. */
#define BCM_PHYS_TO_K0(x)	((x) | 0x80000000)
#define BCM_PHYS_TO_K1(x)	((x) | 0xa0000000)
#define BCM_K0_TO_PHYS(x)	((x) & 0x1fffffff)
#define BCM_K1_TO_PHYS(x)	(K0_TO_PHYS(x))
