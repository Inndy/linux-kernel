...
DESCRIPTION
        This file contains the RFCOMM Interface primitives - the top interface to
        RFCOMM. Multiple applications will be able to post to this interface. Each 
        protocol is responsible for registering a PSM and associated
        handle so that RFCOMM knows where to send incoming events.

REFERENCES
        C6066-S-001 Bluetooth Software Architecture Description
        C6066-S-007 RFCOMM Subsystem design description

*******************************************************************************/
#ifndef BLUESTACK__RFCOMM_PRIM_H /* Once is enough */
#define BLUESTACK__RFCOMM_PRIM_H
#ifdef RCS_STRINGS
static const char* const rfcomm_prim_h_id = "$Header: //depot/bchs/release/15.3/inc/rfcomm_prim.h#3 $";
#endif
#include "hci.h"
