...
DESCRIPTION
    Contains all definitions for the HCI

REFERENCES
    Bluetooth core spec version 1.2
...
#ifdef RCS_STRINGS
static const char* const hci_h_id = "$Header: //depot/bchs/release/15.3/inc/hci.h#4 $";
#endif
#ifndef BTCHIP
...
#define HCI_MAX_LINK_OCF               ((hci_op_code_t) 0x002B)
...
#define HCI_MAX_HOST_BB_OCF            ((hci_op_code_t) 0x0051)
...
#define HCI_MAX_TEST_OCF               ((hci_op_code_t) 0x0004)
...
#define HCI_DEBUG_STATS_PARK           ((uint16_t) 0x000a)
...
/* Mark ACL Data as an HCI event */
#define HCI_ACL_DATA_PACKET_IND                 ((hci_event_code_t)0x2F)

#define HCI_MAX_EVENT_OPCODE                    ((hci_event_code_t)0x30)
...
#define HCI_MAX_HOST_BB_RET_OCF            ((hci_op_code_t) 0x0049)
 ...
 *****************************************************************************/
#define HCI_PKT_BOUNDARY_FLAG_RESERVED ((hci_packet_boundary_flag_t)0)
#define HCI_PKT_BOUNDARY_FLAG_CONT     ((hci_packet_boundary_flag_t)0x1000)
#define HCI_PKT_BOUNDARY_FLAG_FIRST    ((hci_packet_boundary_flag_t)0x2000)
...
#define HCI_ERROR_UNSUPPORTED_REM_FEATURE   ((hci_error_t)0x1A)
...
#define HCI_EV_MASK_INQUIRY_COMPLETE_HI     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_INQUIRY_COMPLETE_LO     ((hci_event_mask_t)0x00000001)
#define HCI_EV_MASK_INQUIRY_RESULT_HI       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_INQUIRY_RESULT_LO       ((hci_event_mask_t)0x00000002)
#define HCI_EV_MASK_CONN_COMPLETE_HI        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_CONN_COMPLETE_LO        ((hci_event_mask_t)0x00000004)
#define HCI_EV_MASK_CONN_REQ_HI             ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_CONN_REQ_LO             ((hci_event_mask_t)0x00000008)
#define HCI_EV_MASK_DISC_COMPLETE_HI        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_DISC_COMPLETE_LO        ((hci_event_mask_t)0x00000010)
#define HCI_EV_MASK_AUTH_COMPLETE_HI        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_AUTH_COMPLETE_LO        ((hci_event_mask_t)0x00000020)
#define HCI_EV_MASK_REM_NAME_REQ_COMP_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_REM_NAME_REQ_COMP_LO    ((hci_event_mask_t)0x00000040)
#define HCI_EV_MASK_CHG_CONN_ENC_EN_HI      ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_CHG_CONN_ENC_EN_LO      ((hci_event_mask_t)0x00000080)
#define HCI_EV_MASK_CHG_CONN_LINK_KEY_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_CHG_CONN_LINK_KEY_LO    ((hci_event_mask_t)0x00000100)
#define HCI_EV_MASK_MASTER_LINK_KEY_HI      ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_MASTER_LINK_KEY_LO      ((hci_event_mask_t)0x00000200)
#define HCI_EV_MASK_READ_REM_SUPP_FEAT_HI   ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_READ_REM_SUPP_FEAT_LO   ((hci_event_mask_t)0x00000400)
#define HCI_EV_MASK_READ_REM_EXT_FEAT_HI    ((hci_event_mask_t)0x00000004)
#define HCI_EV_MASK_READ_REM_EXT_FEAT_LO    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_READ_REM_VER_INFO_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_READ_REM_VER_INFO_LO    ((hci_event_mask_t)0x00000800)
#define HCI_EV_MASK_QOS_SETUP_COMP_HI       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_QOS_SETUP_COMP_LO       ((hci_event_mask_t)0x00001000)
#define HCI_EV_MASK_COMMAND_COMPLETE_HI     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_COMMAND_COMPLETE_LO     ((hci_event_mask_t)0x00002000)
#define HCI_EV_MASK_COMMAND_STATUS_HI       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_COMMAND_STATUS_LO       ((hci_event_mask_t)0x00004000)
#define HCI_EV_MASK_HARDWARE_ERROR_HI       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_HARDWARE_ERROR_LO       ((hci_event_mask_t)0x00008000)
#define HCI_EV_MASK_FLUSH_OCCURRED_EV_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_FLUSH_OCCURRED_EV_LO    ((hci_event_mask_t)0x00010000)
#define HCI_EV_MASK_ROLE_CHANGE_HI          ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ROLE_CHANGE_LO          ((hci_event_mask_t)0x00020000)
#define HCI_EV_MASK_NUM_HCI_DATA_PKTS_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_NUM_HCI_DATA_PKTS_LO    ((hci_event_mask_t)0x00040000)
#define HCI_EV_MASK_MODE_CHANGE_HI          ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_MODE_CHANGE_LO          ((hci_event_mask_t)0x00080000)
#define HCI_EV_MASK_RETURN_LINK_KEYS_HI     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_RETURN_LINK_KEYS_LO     ((hci_event_mask_t)0x00100000)
#define HCI_EV_MASK_PIN_CODE_REQ_HI         ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_PIN_CODE_REQ_LO         ((hci_event_mask_t)0x00200000)
#define HCI_EV_MASK_LINK_KEY_REQ_HI         ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_LINK_KEY_REQ_LO         ((hci_event_mask_t)0x00400000)
#define HCI_EV_MASK_LINK_KEY_NOTIFY_HI      ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_LINK_KEY_NOTIFY_LO      ((hci_event_mask_t)0x00800000)
#define HCI_EV_MASK_LOOPBACK_COMMAND_HI     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_LOOPBACK_COMMAND_LO     ((hci_event_mask_t)0x01000000)
#define HCI_EV_MASK_DATA_BUFFER_OVERFLOW_HI ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_DATA_BUFFER_OVERFLOW_LO ((hci_event_mask_t)0x02000000)
#define HCI_EV_MASK_MAX_SLOTS_CHANGE_HI     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_MAX_SLOTS_CHANGE_LO     ((hci_event_mask_t)0x04000000)
#define HCI_EV_MASK_READ_CLOCK_OFFSET_HI    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_READ_CLOCK_OFFSET_LO    ((hci_event_mask_t)0x08000000)
#define HCI_EV_MASK_CONN_PKT_TYPE_HI        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_CONN_PKT_TYPE_LO        ((hci_event_mask_t)0x10000000)
#define HCI_EV_MASK_QOS_VIOLATION_HI        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_QOS_VIOLATION_LO        ((hci_event_mask_t)0x20000000)
#define HCI_EV_MASK_PAGE_SCAN_MODE_HI       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_PAGE_SCAN_MODE_LO       ((hci_event_mask_t)0x40000000)
#define HCI_EV_MASK_PAGE_SCAN_REP_MODE_HI   ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_PAGE_SCAN_REP_MODE_LO   ((hci_event_mask_t)0x80000000)

/* 1.2 Features */
#define HCI_EV_MASK_FLOW_SPEC_COMPLETE_HI    ((hci_event_mask_t)0x00000001)
#define HCI_EV_MASK_FLOW_SPEC_COMPLETE_LO    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_INQUIRY_RESULT_RSSI_HI   ((hci_event_mask_t)0x00000002)
#define HCI_EV_MASK_INQUIRY_RESULT_RSSI_LO   ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_RR_EXT_FEATURES_HI       ((hci_event_mask_t)0x00000004)
#define HCI_EV_MASK_RR_EXT_FEATURES_LO       ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_FIXED_ADDRESS_HI         ((hci_event_mask_t)0x00000008)
#define HCI_EV_MASK_FIXED_ADDRESS_LO         ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ALIAS_ADDRESS_HI         ((hci_event_mask_t)0x00000010)
#define HCI_EV_MASK_ALIAS_ADDRESS_LO         ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_GENERATE_ALIAS_REQ_HI    ((hci_event_mask_t)0x00000020)
#define HCI_EV_MASK_GENERATE_ALIAS_REQ_LO    ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ACTIVE_ADDRESS_HI        ((hci_event_mask_t)0x00000040)
#define HCI_EV_MASK_ACTIVE_ADDRESS_LO        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ALLOW_PRIVATE_PAIRING_HI ((hci_event_mask_t)0x00000080)
#define HCI_EV_MASK_ALLOW_PRIVATE_PAIRING_LO ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ALIAS_ADDRESS_REQ_HI     ((hci_event_mask_t)0x00000100)
#define HCI_EV_MASK_ALIAS_ADDRESS_REQ_LO     ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_ALIAS_NOT_RECOGNISED_HI  ((hci_event_mask_t)0x00000200)
#define HCI_EV_MASK_ALIAS_NOT_RECOGNISED_LO  ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_FIXED_ADDRESS_ATTEMPT_HI ((hci_event_mask_t)0x00000400)
#define HCI_EV_MASK_FIXED_ADDRESS_ATTEMPT_LO ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_SYNC_CONN_COMP_HI        ((hci_event_mask_t)0x00000800)
#define HCI_EV_MASK_SYNC_CONN_COMP_LO        ((hci_event_mask_t)0x00000000)
#define HCI_EV_MASK_SYNC_CONN_CHANGED_HI     ((hci_event_mask_t)0x00001000)
#define HCI_EV_MASK_SYNC_CONN_CHANGED_LO     ((hci_event_mask_t)0x00000000)

/* > 1.2 features */
#define HCI_EV_MASK_SNIFF_SUB_RATE_HI        ((hci_event_mask_t)0x00002000)
#define HCI_EV_MASK_SNIFF_SUB_RATE_LO        ((hci_event_mask_t)0x00000000)

#define HCI_EV_MASK_DEFAULT_HI               ((hci_event_mask_t)0x00003FFF)
...
#define HCI_INQUIRYSCAN_INTERVAL_DEFAULT    ((uint16_t)0x0800)
#define HCI_INQUIRYSCAN_INTERVAL_MAX        ((uint16_t)0x1000)
#define HCI_INQUIRYSCAN_WINDOW_MIN          ((uint16_t)0x0012)
...
#define HCI_SNIFF_SUB_RATE_LATENCY_MAX  ((uint16_t)0x9FFF)
#define HCI_SNIFF_SUB_RATE_TIMEOUT_MAX  ((uint16_t)0x9FFF)
 ...
 *
 *---------------------------------------------------------------------------*/
#define HCI_PAGESCAN_WINDOW_MIN       ((uint16_t) 0x12)
...
/*-----------------------------------------------------------------------------*
 *
 *   Supported features definitions
 *
 *------------------------------------------------------------------------------*/
/* Byte 0 features */
#define HCI_FEATURE_3_SLOT_PACKETS              ((uint8_t) 0x01)
#define HCI_FEATURE_5_SLOT_PACKETS              ((uint8_t) 0x02)
#define HCI_FEATURE_ENCRYPTION                  ((uint8_t) 0x04)
#define HCI_FEATURE_SLOT_OFFSET                 ((uint8_t) 0x08)
#define HCI_FEATURE_TIMING_ACCURACY             ((uint8_t) 0x10)
#define HCI_FEATURE_SWITCH                      ((uint8_t) 0x20)
#define HCI_FEATURE_HOLD_MODE                   ((uint8_t) 0x40)
#define HCI_FEATURE_SNIFF_MODE                  ((uint8_t) 0x80)
/* Byte 1 features */
#define HCI_FEATURE_PARK_MODE                   ((uint8_t) 0x01)
#define HCI_FEATURE_RSSI                        ((uint8_t) 0x02)
#define HCI_FEATURE_CQD_DATA_RATE               ((uint8_t) 0x04)
#define HCI_FEATURE_SCO_LINK                    ((uint8_t) 0x08)
#define HCI_FEATURE_HV2_PACKETS                 ((uint8_t) 0x10)
#define HCI_FEATURE_HV3_PACKETS                 ((uint8_t) 0x20)
#define HCI_FEATURE_U_LAW_LOG                   ((uint8_t) 0x40)
#define HCI_FEATURE_A_LAW_LOG                   ((uint8_t) 0x80)
/* Byte 2 features */
#define HCI_FEATURE_CVSD                        ((uint8_t) 0x01)
#define HCI_FEATURE_PAGING_SCHEME               ((uint8_t) 0x02)
#define HCI_FEATURE_POWER_CONTROL               ((uint8_t) 0x04)
#define HCI_FEATURE_TRANSPARENT_SCO_DATA        ((uint8_t) 0x08)
#define HCI_FEATURE_FLOW_CONTROL_LAG_BIT0       ((uint8_t) 0x10)
#define HCI_FEATURE_FLOW_CONTROL_LAG_BIT1       ((uint8_t) 0x20)
#define HCI_FEATURE_FLOW_CONTROL_LAG_BIT2       ((uint8_t) 0x40)
...
#define HCI_MAX_INQ_RESULT_PER_PTR              (5)/**/ /*(HCI_VAR_ARG_POOL_SIZE/HCI_ARC_CONVERT(HCI_INQ_RESULT_T))*/
#define HCI_MAX_INQ_RESULT_PTRS                 (6)/**/ /*( ((254 / HCI_BYTE_SIZE_OF_HCI_INQ_RESULT_T) + HCI_MAX_INQ_RESULT_PER_PTR -1) / HCI_MAX_INQ_RESULT_PER_PTR)*/
#else
#define HCI_MAX_INQ_RESULT_PER_PTR              (HCI_VAR_ARG_POOL_SIZE/HCI_ARC_CONVERT(HCI_INQ_RESULT_T))
