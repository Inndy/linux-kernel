...
DESCRIPTION
    This file contains the Bluetooth specific type definitions.
...
#ifdef RCS_STRINGS
static const char* const bluetooth_h_id = "$Header: //depot/bchs/release/15.3/inc/bluetooth.h#2 $";
#endif
...
#define DM_PRIM			4	/* uint16 parameter. We are using it */
