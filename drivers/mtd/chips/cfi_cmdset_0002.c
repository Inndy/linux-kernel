...
static void fixup_use_write_buffers(struct mtd_info *mtd, void *param)
{
	struct map_info *map = mtd->priv;
	struct cfi_private *cfi = map->fldrv_priv;
	printk(KERN_NOTICE "fixup_use_write_buffers\n");
...
static void fixup_S29GLxxxN_use_write_words(struct mtd_info *mtd, void *param)
{
	...
	/*
	 * NOTE: cfi_read_query always returns a uint8, so some of these
	 * checks are bogus.
	 */
	if (id == 0x227E || id == 0x7e) {
		if ((id1 == 0x2223 || id1 == 0x23) && (id2 == 0x2201 || id2 == 0x01)) // S29GL512N
			...
			is_S29GLxxxN_chip = 1;
		else if ((id1 == 0x2221 || id1 == 0x21) && (id2 == 0x2201 || id2 == 0x01)) // S29GL128N
			is_S29GLxxxN_chip = 1;
	}
...
static struct cfi_fixup cfi_fixup_table[] = {
	 ...
	 * Placing this after the previous entry will override it.
         * This affects 7400a0, possibly others
         *
         * NOTE: In x16 mode the id will be read as 0x227e.
	 *
	 * PR30495: changed workaround so it is only active on 7400a0
	 */
