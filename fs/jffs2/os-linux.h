...
#else
#define jffs2_flash_write_oob(c, ofs, len, retlen, buf) ((c)->mtd->write_oobfree((c)->mtd, ofs, len, retlen, buf))
#define jffs2_flash_read_oob(c, ofs, len, retlen, buf) ((c)->mtd->read_oobfree((c)->mtd, ofs, len, retlen, buf))
#endif
