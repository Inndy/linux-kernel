 ...
 * 2) Look for CPU_FREQ_BRCM in arch/mips/Kconfig and update the conditional
 *    (it will not be built by default since old platforms don't support it)
 * 3) Update arch/mips/kernel/configs/*defconfig
 */
